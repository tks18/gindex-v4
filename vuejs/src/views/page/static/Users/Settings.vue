      ...
      <div class="columns has-text-white is-centered is-multiline">
        <div class="column is-two-thirds">
          <div class="box has-background-light">
            <h3
              class="title has-text-centered has-text-weight-bold has-text-info-dark"
            >
              Your Details
            </h3>
            <div
            ...
            >
              <div class="column has-text-centered is-full">
                <figure class="image special-image is-128x128 is-inline-block">
                  <img
                    class="is-rounded"
                    :src="avatar"
                    @click="alerts('Avatar Under Development')"
                  />
                </figure>
              </div>
              ...
              <div
                v-if="(!admin && !superadmin) || (admin && !superadmin)"
              ...
              <div
                v-if="(!admin && !superadmin) || (admin && !superadmin)"
                class="column has-text-centered is-two-fifths"
              >
                <v-btn
                  class="is-netflix-red"
                  @click="gotoPage('/request/', 'settings')"
                >
              ...
              >
                <p class="subtitle has-text-warning-dark has-text-weight-bold">
                  You Have Maximum Access to this Website
                </p>
              </div>
              <div class="column is-three-fifths">
              ...
              <div class="column is-two-fifths">
                <p class="subtitle has-text-weight-bold">
                  {{
                    token.issuedate | moment('dddd, MMMM Do YYYY [at] hh:mm A')
                  }}
                </p>
              </div>
              <div class="column is-three-fifths">
              ...
              <div class="column is-two-fifths">
                <p class="subtitle has-text-weight-bold">
                  {{
                    token.expirydate | moment('dddd, MMMM Do YYYY [at] hh:mm A')
                  }}
                </p>
              </div>
            </div>
          ...
          <div class="columns is-multiline is-desktop is-centered">
              ...
              <div class="box has-background-light">
                ...
                >
                  ...
                  <div class="column has-text-centered is-two-fifths">
                    <v-btn
                      class="is-rounded is-netflix-red"
                      @click="gotoPage('/changepassword/', 'settings')"
                    >
                      <span class="icon is-small">
            ...
            <div class="column is-full">
              <div class="box has-background-danger">
                <h3
                  class="title has-text-centered has-text-white has-text-weight-bold"
                >
                  Danger Zone
                </h3>
                <div
...
export default {
  ...
  mounted() {
    ...
    if (this.user.avatar) {
      ...
      this.avatar =
        'https://cdn.statically.io/img/www.joyonlineschool.com/static/emptyuserphoto.png?w=64&h=64&quality=100&f=auto';
    }
  },
  created() {
