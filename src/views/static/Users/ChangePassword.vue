<template>
  ...
  >
    ...
    <div
      class="columns is-multiline is-desktop has-text-centered is-centered is-vcentered"
    >
      <div class="column is-full">
        <h2 class="title has-text-weight-bold has-text-white">
          Change Your Password
        </h2>
        <p class="subtitle has-text-danger-dark">
          Enter Your Old Password and Change
        </p>
      </div>
            ...
            if (
              ...
              this.$router.push({
                ...
                params: {
                  ...
                  redirectUrl: '/',
                  tocmd: 'login',
                  data: `response.data.message. You have to Relogin with new Password`,
                },
              });
            } else {
