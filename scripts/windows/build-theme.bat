...
set themes=carnation curious^-blue emerald ice^-cold konifer netflix^-red kournikova mona^-lisa persian^-rose purple^-heart purple^-mountains^-majesty salmon selective^-yellow shamrock witch^-haze
for %%b in (%themes%) do (
  set /A i+=1
  echo %i%. %%b
)
