      ...
      <div class="column is-half">
        <div class="content has-text-white has-text-centered">
          <p class="has-text-weight-semibold">
            Login to this Website to Continue.
          </p>
                ...
                <div class="field">
                  <p class="control has-icons-left">
                    <input
                      ...
                      id="hypassword"
                      autocomplete="hy-password"
                      type="password"
                      placeholder="Enter Your Hybrid Password"
                      v-model="hypassword"
                      required
                    />
  ...
  methods: {
    ...
    async handleHybrid() {
      ...
      if (synced) {
        ...
        var dataFromLocal = await JSON.parse(
          decodeSecret(getItem('hybridToken')),
        );
