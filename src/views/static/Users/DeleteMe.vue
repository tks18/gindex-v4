<template>
  <div
    :class="
      ismobile
        ? 'content mt-4 mt-2 mx-1 px-0'
        : 'content mt-4 mt-2 ml-5 mr-5 pl-5 pr-5'
    "
  >
    <div class="loading">
      <loading
    ...
    <div
      class="columns is-multiline has-text-centered is-desktop is-centered is-vcentered"
    >
      <div class="column is-full">
        <h2 class="title has-text-weight-bold has-text-white">
          Delete Your Account
        </h2>
        <p class="is-small has-text-danger-dark has-text-weight-bold">
          Be Cautious !!
        </p>
      </div>
                ...
                setTimeout(() => {
                  ...
                  this.$router.push({
                    ...
                    params: {
                      ...
                      cmd: 'result',
                      success: true,
                      data: 'You Account is Being Deleted. Please Wait',
                      redirectUrl: '/',
                      tocmd: 'home',
                    },
                  });
