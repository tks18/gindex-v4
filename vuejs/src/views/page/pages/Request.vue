            ...
            <div class="field">
              ...
              <label class="checkbox mb-3">
                <input class="has-text-success" type="checkbox" id="terms" name="terms" v-model="checked">
                  <span class="content has-text-white">  I Accept and Read the <a class="has-text-success" href="https://github.com/tks18/gindex-v4/blob/dark-mode-0-1/CODE_OF_CONDUCT.md" target="_blank">Community Guidelines</a></span>
              </label>
              <button :class=" loading ? 'button is-loading is-warning is-medium' : 'button is-warning is-medium' " type="submit" :disabled="disabled" >
                <span class="icon">
