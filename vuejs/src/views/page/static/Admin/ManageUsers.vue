      ...
      <div class="columns mx-3 is-mobile is-multiline is-vcentered">
        ...
        <div :class="usermodal ? 'modal is-active' : 'modal'">
          ...
          <div class="modal-card">
            ...
            <section class="modal-card-body">
              <div
                class="columns is-mobile is-centered is-vcentered is-multiline"
              >
                <div class="column is-half">
                  <p class="subtitle has-text-black has-text-weight-normal">
                    Name
                  </p>
                </div>
                <div class="column is-half">
                  <p class="subtitle has-text-black has-text-weight-semibold">
                    {{ currentUser.name }}
                  </p>
                </div>
                <div class="column is-half">
                  ...
                  :class="
                    admin && superadmin
                      ? currentUser.admin &&
                        ...
                        : 'column has-text-right is-quarter'
                      : 'column has-text-centered is-half'
                  "
                >
                  <v-btn
                    class="is-rounded is-netflix-red"
                    @click="handleUpgradeDelete(currentUser, 'delete')"
                  >
                    Delete
                  </v-btn>
                </div>
                <div
                  ...
                  v-if="
                    ...
                    !currentUser.pending
                  "
                  class="column has-text-left is-quarter has-text-centered"
                >
                  <v-btn
                    class="is-rounded is-netflix-red"
                    @click="inviteInput = true"
                  >
                    Invite as Admin
                  </v-btn>
                </div>
                ...
                >
                  <button
                    class="button is-rounded is-netflix-red"
                ...
                <div v-if="inviteInput" class="column is-full">
                  <div class="columns is-mobile is-multiline is-centered">
                    ...
                    <div class="column has-text-right is-half">
                      <v-btn
                        class="is-rounded is-netflix-red"
                        @click="handleInvite(currentUser)"
                      >
                        Invite
                      </v-btn>
                    </div>
                    <div
                      ...
                      "
                    >
                      <v-btn class="is-rounded is-netflix-red"> Cancel </v-btn>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div v-else class="column is-full">
          <p class="subtitle has-text-centered has-text-white">
            Please Click Refresh Button to Load Users
          </p>
        </div>
      </div>
    </div>
