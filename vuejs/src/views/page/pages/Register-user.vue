<template>
    <div class="content registration-page">
      <div class="top-buttons" v-if="userData.admin || userData.superadmin">
        <button class="registration-top-buttons" type="submit" @click="homeroute">Home</button>
        <button class="registration-top-buttons" type="submit" @click="adminroute">Admin Area</button>
        <button class="registration-top-buttons" type="submit" @click="contentroute">View Content</button>
        <button class="registration-top-buttons" type="submit" @click="settingsroute">My Settings</button>
      </div>
      <div class="top-buttons" v-else>
        <button class="registration-top-buttons" type="submit" @click="homeroute">Home</button>
        <button class="registration-top-buttons" type="submit" @click="adminroute">My Settings</button>
        <button class="registration-top-buttons" type="submit" @click="contentroute">View Content</button>
      </div>
      <hr>
        <h4>Register</h4>
