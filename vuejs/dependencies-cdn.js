module.exports = [
  ...
  { name: '', library: '', js: '', css: 'https://fonts.googleapis.com/css?family=Roboto:100,300,400,500,700,900' },
  { name: '', library: '', js: '', css: 'https://cdn.jsdelivr.net/npm/@mdi/font@5.x/css/materialdesignicons.min.css' },
  { name: '', library: '', js: 'https://unpkg.com/vue-select@latest', css: '' },
  { name: 'v-select', library: 'vselect', js: '', css: 'https://unpkg.com/vue-select@latest/dist/vue-select.css' }
