<template>
  <div :class="ismobile ? 'content mx-1 mt-2 px-0' : 'content ml-5 mt-2 mr-5 pl-5 pr-5 '">
    <h1 class="title has-text-centered has-text-weight-bold has-text-white">Manage Categories</h1>
    <div class="loading">
        ...
        <div class="modal-card">
          ...
          <section class="modal-card-body">
            <div class="columns is-multiline is-centered is-vcentered">
              ...
              <div class="column is-two-thirds">
                <div class="control">
                  <input class="input is-rounded" id="add-cat-poster" placeholder="Poster Link Here" type="text" v-model="addData.poster">
                </div>
              </div>
              <div class="column is-one-third">
              ...
              <div class="column is-two-thirds">
                <div class="control">
                  <input class="input is-rounded" id="add-cat-title" placeholder="Display Title Here" type="text" v-model="addData.title">
                </div>
              </div>
              <div class="column is-one-third">
              ...
              <div class="column is-two-thirds">
                <div class="control">
                  <input class="input is-rounded" id="add-cat-link" placeholder="Folder Link Here" type="text" v-model="addData.link">
                </div>
              </div>
            </div>
          </section>
